...
#ifndef MUSKETEER_UNION_OPERATOR_H
#define MUSKETEER_UNION_OPERATOR_H
...
class UnionOperator: public OperatorInterface {
 public:
  UnionOperator(const string& input_dir, const vector<Relation*>& relations,
                Relation* output_rel):
