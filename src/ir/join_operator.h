...
#ifndef MUSKETEER_JOIN_OPERATOR_H
#define MUSKETEER_JOIN_OPERATOR_H
...
class JoinOperator: public OperatorInterface {
 public:
  JoinOperator(const string& input_dir, const vector<Relation*>& relations,
