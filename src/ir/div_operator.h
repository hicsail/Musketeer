...
#ifndef MUSKETEER_DIV_OPERATOR_H
#define MUSKETEER_DIV_OPERATOR_H
...
class DivOperator : public OperatorInterface {
 public:
  DivOperator(const string& input_dir, const pANTLR3_BASE_TREE condition_tree,
  ...
  DivOperator(const string& input_dir,
  ...
  DivOperator(const string& input_dir, ConditionTree* condition_tree,
              const vector<Relation*>& relations, const vector<Value*>& values_,
              Relation* output_rel):
