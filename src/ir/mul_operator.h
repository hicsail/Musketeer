...
class MulOperator : public OperatorInterface {
 public:
  MulOperator(const string& input_dir, const pANTLR3_BASE_TREE condition_tree,
  ...
  MulOperator(const string& input_dir,
  ...
  MulOperator(const string& input_dir, ConditionTree* condition_tree,
              const vector<Relation*>& relations, const vector<Value*>& values_,
              Relation* output_rel):
