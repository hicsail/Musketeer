...
namespace ir {
  ...
  Column* JoinOperatorSEC::get_col_left() {
    return left_cols_[0];
  }

  Column* JoinOperatorSEC::get_col_right() {
    return right_cols_[0];
  }

  vector<Column*> JoinOperatorSEC::get_left_cols() {
    return left_cols_;
  }

  vector<Column*> JoinOperatorSEC::get_right_cols() {
    return right_cols_;
  }
  ...
  pair<uint64_t, uint64_t> JoinOperatorSEC::get_output_size(
