...
#ifndef MUSKETEER_VIFF_JOB_CODE_H
#define MUSKETEER_VIFF_JOB_CODE_H
...
class ViffJobCode : public MapReduceJobCode {
 public:
  ViffJobCode(OperatorInterface* op, const string& map_variables_code_,
  ...
  ViffJobCode(OperatorInterface* op, const string& code):
